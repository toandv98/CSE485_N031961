    ...
    <div class="container-fullwidth">
        ...
        <main class="col-md-11 m-auto">
            ...
            <div class="left col-md-8 float-left">
                ...
                <?php
                    ...
                    $display = 6;
                    $sql = "SELECT * from baihat where idtheloai = '$id' limit $position,$display";
        ...
        <div class="pagination">
            ...
            <?php
                $id = $_GET["id"];
                require('./php/connect.php');
                $result = mysqli_query($con,"SELECT tenbaihat From baihat where idtheloai = '$id'");
                ...
                if($sum_page>1)
                {
                    echo '<ul style="list-style:none;display:inline-flex;">';
                        ...
                        {   
                            ...
                            echo "<li><a href='nhactre.php?id=$id&begin=$prev' class='page'>Prev</a></li>";
                        }
                        ...
                        for($page=1;$page<=$sum_page;$page++)    
                        {
                            ...
                            if($current == $page)
                            {
                                echo "<li><a href='nhactre.php?id=$id&begin=$begin' style='background:#00B2BF;color:#f4f4f4; '  class='page'>$page</a></li>";
                            }
                            else
                            {
                                echo "<li><a href='nhactre.php?id=$id&begin=$begin' class='page'>$page</a></li>";
                            }
                        }
                        if($current != $sum_page)
                        {
                            $next = $position + $display;
                            echo "<li><a href='nhactre.php?id=$id&begin=$next' class='page'>Next</a></li>";
                        }
                        if($current = $sum_page)
                        {
                            $last = (($display*$sum_page) - $display);
                            echo "<li><a href='nhactre.php?id=$id&begin=$last' class='page'>Last </a></li>";
                        }
