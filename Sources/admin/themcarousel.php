...
<body>
            ...
            if ($_FILES['uploadimg']['size'] < 4000000)
            {
                if(preg_match($pattern,$image)==1)
                {
                    ...
                    {	
                        ...
                        $update=mysqli_query($con,"Insert Into carousel(ten,image) value('$ten','$dest')");
                        mysqli_close($con);
                        if($update)
                        {
                            echo "<h3 style='color:blue;'>Thêm carousel thành công...</h3>";
                         }
                        else
                        {
                            echo "<h3 style='color:red;'>Thêm carousel thất bại!</h3>";
                        }
                    }
                    else
                    {
    ...
    <main class="col-md-8 m-auto p-5">
          <form class="" action="./themcarousel.php" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-8 m-auto">
                    <div class="row"><div class="col-md-12 text-center mb-3"><label style="font-size:24px">Thêm carousel</label></div></div>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label form-control-label">Tên:</label>
                        <div class="col-md-9">
